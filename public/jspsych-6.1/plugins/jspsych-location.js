...
jsPsych.plugins["location"] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    html += '<input type="submit" id="jspsych-location-next" class="jspsych-location jspsych-btn" value="' + trial.button_label + '"></input>';
    html += '</form>';
    ...
    display_element.querySelector('#jspsych-location-form').addEventListener('submit', function (e) {
      e.preventDefault();
